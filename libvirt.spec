...
Name: libvirt
Version: 0.10.2
Release: 62%{?dist}.1%{?extra_release}
License: LGPLv2+
...
Patch928: libvirt-virsh-Properly-display-block-job-type.patch
Patch929: libvirt-Revert-qemu-snapshot-Fix-modification-of-vm-object-without-job.patch
Patch930: libvirt-qemu-snapshot-Fix-job-handling-when-creating-snapshots.patch
Patch931: libvirt-tls-remove-support-for-gnutls-1.x.x-require-2.2.0.patch
Patch932: libvirt-configure-allow-setting-default-TLS-priority-string.patch
Patch933: libvirt-rpc-allow-priority-string-to-be-passed-to-TLS-context.patch
Patch934: libvirt-libvirtd-add-config-option-for-TLS-priority.patch
Patch935: libvirt-remote-allow-TLS-protocol-cipher-priority-override-in-URI.patch
Patch936: libvirt-Pass-config-file-object-through-to-driver-open-methods.patch
Patch937: libvirt-remote-allow-TLS-priority-to-be-customized.patch
Patch938: libvirt-qemu-numa-doesn-t-yet-support-disjoint-range.patch
Patch939: libvirt-qemu-fix-return-value-of-qemuDomainBlockPivot-on-errors.patch
Patch940: libvirt-qemu-Fix-virsh-freeze-when-blockcopy-storage-file-is-removed.patch
Patch941: libvirt-migration-add-support-for-migrateURI-configuration.patch
Patch942: libvirt-util-Implement-virFileReadHeaderFD.patch
Patch943: libvirt-util-add-virFileReadHeaderQuiet-wrapper-around-virFileReadHeaderFD.patch
...
* Mon Oct 31 2016 Jiri Denemark <jdenemar@redhat.com> - 0.10.2-62
...
* Thu Oct 13 2016 Jiri Denemark <jdenemar@redhat.com> - 0.10.2-61
- virsh: Properly display block job type (rhbz#1326653)
- spec: proper soft static allocation of qemu uid (rhbz#1351792)
- Revert "qemu: snapshot: Fix modification of vm object without job" (rhbz#1326652)
